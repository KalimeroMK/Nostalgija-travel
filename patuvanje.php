<?php
require 'header.php';
require 'paginationpatuvanja.php';?>
                ...
                <div class="slider-banner-container">
                    <div class="slider-banner-boxedwidth">
                        <ul class="slides">
                            ...
                            <!-- ================ -->
                            <?php
                            $results1 = mysqli_query($con, "SELECT * FROM tekst WHERE type='Далечни Патувања' ORDER BY id DESC LIMIT 5");
                        ...
                        data-speed="500"
                        data-start="1000"
                        data-easing="easeOutQuad">Get <span class="text-default">50%</span>' . $title1 . '
                    </div>
                    <!-- LAYER NR. 2 -->
