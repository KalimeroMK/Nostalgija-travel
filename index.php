            ...
            <div class="slider-banner-container">
                <div class="slider-banner-boxedwidth">
                    <ul class="slides">
                        ...
                        <!-- ================ -->
                        <?php
                        $results1 = mysqli_query($con, "SELECT * FROM tekst ORDER BY RAND() LIMIT 20");
                        ...
                        <div class="tp-bannertimer"></div></ul>
                            <li></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-md-8">
                ...
                <div class="col-md-4">
                    <div class="overlay-container">';
                        ...
                        echo ' <img src="http://dev.nostalgijatravel.mk/' . $image . '"  alt="' . $title . ' width="200" height="200" class="img-responsive img-rounded">';
                        }
                        $kopche = '... ';
