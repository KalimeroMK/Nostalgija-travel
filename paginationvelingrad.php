...
$query = "SELECT COUNT(*) as num FROM tekst WHERE grad ='Велинград'";
...
// Get page data
$query1 = "SELECT * FROM tekst WHERE grad ='Велинград' ORDER BY id DESC LIMIT $start, $limit";
...
if ($lastpage > 1) {
    ...
    if ($page > 1) {
        $paginate .= '<li><a href="/velingrad/' . $prev . '/" aria-label="Previous"><i class=" glyphicon glyphicon-chevron-left"></i></a></li>';
    } else {
